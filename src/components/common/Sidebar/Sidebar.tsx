...
export const Sidebar: FC = () => {
  ...
  const [activeButtonsSkills, setActiveButtonsSkills] = useState(true);
        ...
        <div className={cn(styles.wrapper, 'p-relative')}>
          <div className={styles.profile}>
            <div className={styles.photo}>
              <img src={dataPortfolio.photo} alt='' />
            </div>
            <div className={styles.info}>
              <h1>{dataPortfolio.name}</h1>
              <h2>{dataPortfolio.profession}</h2>
              <div className={styles.location}>
                ...
                <p>{dataPortfolio.location}</p>
              </div>
            </div>
          </div>
          <div className={styles.skills}>
            <button
              className={cn('p-relative', activeButtonsSkills ? styles.active : undefined)}
              onClick={() => {
                delayShowSkills()
              }}
            >
              My Skills
              <svg className={activeButtonsSkills ? styles.active : undefined} width="25" height="24"
                   viewBox="0 0 25 24"
                   fill="none"
            ...
            <ul className={showSkills ? styles.show : undefined}>
              {dataPortfolio.skills.map((skill, index) => (
